...
namespace bluesim
{
  ...
  MOD_mkTestBench::MOD_mkTestBench(char const *name, Module *parent)
    : Module(name, parent),
      ...
      INST_cycleCount("cycleCount", this, 32u, 0u, (tUInt8)0u),
      INST_done("done", this, 1u, (tUInt8)0u, (tUInt8)0u),
      INST_dut("dut", this),
  ...
  void MOD_mkTestBench::RL_countCycles()
  {
    ...
    DEF_b__h1858 = INST_cycleCount.METH_read();
    DEF_signed_cycleCount_9___d31 = DEF_b__h1858;
    DEF_cycleCount_9_PLUS_1___d30 = DEF_b__h1858 + 1u;
    INST_cycleCount.METH_write(DEF_cycleCount_9_PLUS_1___d30);
    if (!(PORT_RST_N == (tUInt8)0u))
      dollar_display(this, "s,-32", &__str_literal_2, DEF_signed_cycleCount_9___d31);
  }
  ...
  void MOD_mkTestBench::reset_RST_N(tUInt8 ARG_rst_in)
  {
    ...
    INST_done.reset_RST_N(ARG_rst_in);
    INST_cycleCount.reset_RST_N(ARG_rst_in);
  }
  ...
  unsigned int MOD_mkTestBench::dump_VCD_defs(unsigned int levels)
  {
    ...
    vcd_write_def(num++, "CAN_FIRE_RL_checkHalt", 1u);
    vcd_set_clock(num, __clk_handle_0);
    vcd_write_def(num++, "CAN_FIRE_RL_countCycles", 1u);
    vcd_set_clock(num, __clk_handle_0);
    vcd_write_def(num++, "CAN_FIRE_RL_finishSim", 1u);
    vcd_write_def(num++, "RST_N", 1u);
    vcd_set_clock(num, __clk_handle_0);
    vcd_write_def(num++, "WILL_FIRE_RL_checkHalt", 1u);
    vcd_set_clock(num, __clk_handle_0);
    vcd_write_def(num++, "WILL_FIRE_RL_countCycles", 1u);
    vcd_set_clock(num, __clk_handle_0);
    vcd_write_def(num++, "WILL_FIRE_RL_finishSim", 1u);
  ...
  void MOD_mkTestBench::vcd_defs(tVCDDumpType dt, MOD_mkTestBench &backing)
  {
	...
	{
	  vcd_write_val(num, DEF_CAN_FIRE_RL_checkHalt, 1u);
	...
	{
	  vcd_write_val(num, DEF_CAN_FIRE_RL_finishSim, 1u);
	...
	{
	  vcd_write_val(num, DEF_WILL_FIRE_RL_checkHalt, 1u);
	...
	{
	  vcd_write_val(num, DEF_WILL_FIRE_RL_finishSim, 1u);
